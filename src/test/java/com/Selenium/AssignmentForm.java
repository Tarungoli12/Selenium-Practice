...
public class AssignmentForm {
    public static void main(String[] args) {
        ...
        driver.findElement(By.name("name")).sendKeys("Meghan");

        driver.findElement(By.name("email")).sendKeys("G");

        driver.findElement(By.id("exampleInputPassword1")).sendKeys("Meghan@123");
        ...
        driver.findElement(By.cssSelector("input[name='bday']")).sendKeys("21091990");
