...
public class LimitingWebDriverScopeAndOpenLinksInSeperateTabsAndTitles {
    ...
    public static void main(String[] args) {
        ...
        //Count of links in the 2nd column of the footer section
        WebElement col = footer.findElement(By.xpath(".//*[@id='gf-BIG']/table/tbody/tr/td[2]/ul"));
